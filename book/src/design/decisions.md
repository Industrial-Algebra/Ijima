...
| `namespace-membership.md` | Shared namespaces are membership-gated in the store (not policy TOML) — runtime-mutable, auditable, effective against already-issued grants; promotion targets gated too |
